...
const ProfileCard: React.FC = () => {
    ...
    const socialLinks = [
        {
            name: 'Email',
            href: 'mailto:apinycom2588@icloud.com',
            icon: (
        ...
        {
            name: 'Facebook',
            href: 'https://facebook.com/Aum-Wilaijit',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="p-4 sm:p-6 lg:p-8 flex flex-col justify-center items-center text-center">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center">
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <p className="text-white font-medium text-sm sm:text-base">apinya2588@iclou.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <p className="text-white font-medium text-sm sm:text-base">+66 (082)123 564</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-xl mb-2">
                        <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                            Hello ผมชื่อ (อั้ม) / ศึกษาอยู่ที่(สาธิตราชภัฏวไลยอลงกรณ์)/ม.5 สายศิลป์ (ภาษาอังกฤษ)
                        </p>
                    </div>
                    ...
                    <div className="space-y-2 mb-4">
                        <h3 className="text-lg font-semibold text-white">IG ไม่บอกอย่าหลอกถาม</h3>
